...
(function($) {
    ...
    function main() {
        ...
        /*==============================
            Toggle cart
        ==============================*/
        $('.toggle-minicart').on('click', function(){
            $('.minicart-wrap')
                .find('.minicart-body')
        ...
        $('.minicart-wrap').on('click', function(e) {
            e.stopPropagation();
        });
    ...
    function fnHeader() {
        ...
        var homeHeight = wHeight - $('header.header').height();
        ...
        if (isMobile.any()) {
            ...
            $(window).on('scroll', function() {
                ...
                if (windownScrolltop > 0 && windownScrolltop <= windowHeight) {
                    $('.onepage')
                        .closest('body')
                            .find('header.header')
                                .addClass('header-anim');
                } else {
                    $('.onepage')
                        .closest('body')
                            .find('header.header')
                                .removeClass('header-anim');
                }
            });
        }
        ...
        $('.onepage').find('.nav > li').on('click', '> a', function(evt) {
            var $anchor = $(this);

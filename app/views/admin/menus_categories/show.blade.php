                ...
                <div class="panel-body border">
                    ...
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {{ Form::text('titulo', $category->titulo, ['class' => 'form-control', 'disabled']) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-right">
                                <a href="{{ route('administrador.menus_categories.edit', $category->id) }}" class="btn btn-responsive btn-primary btn-md">Editar</a>
                                <a href="{{ route('administrador.menus_categories.index') }}" class="btn btn-responsive btn-default btn-md">Ver registros</a>
                            </div>
                        </div>

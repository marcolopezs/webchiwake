...
<section class="content-header">
    <!--section starts-->
    <h1>Entradas</h1>
    <a href="{{ route('administrador.phrases.create') }}" class="btn btn-md btn-default">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="button-dropdown" data-buttons="dropdown">
                                        ...
                                        <ul>
                                            <li><a href="{{ route('administrador.phrases.show', $item->id) }}">Ver</a></li>
                                            <li><a href="{{ route('administrador.phrases.edit', $item->id) }}">Editar</a></li>
                                            <li><a href="{{ route('administrador.phrases.destroy', $item->id) }}">Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>

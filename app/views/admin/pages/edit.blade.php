		...
		<div class="col-lg-12">
			...
			<div class="panel panel-danger">
				<div class="panel-body border">
					{{ Form::model($page, ['route' => ['administrador.pages.update', $page->id], 'method' => 'PUT', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) }}
                        ...
                        <div class="form-group @if($errors->has('imagen')) has-error @endif">
                            ...
                            <div class="col-md-9">
                                <a class="fancybox" href="/upload/{{ $page->imagen_carpeta."".$page->imagen }}" title="{{ $page->titulo }}">
                                    <img src="/upload/{{ $page->imagen_carpeta."200x100/".$page->imagen }}" alt=""/>
                                </a>
                                {{ Form::hidden('imagen_actual', $page->imagen) }}
                                {{ Form::hidden('imagen_actual_carpeta', $page->imagen_carpeta) }}
                            </div>
                        </div>
